...
export interface ApiContactSectionContactSection
  ...
  attributes: {
    contact: Schema.Attribute.Component<'contact-comp.contact', false> &
    ...
    form: Schema.Attribute.Component<'contact-comp.form', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    social: Schema.Attribute.Component<'service-comp.social', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    connect: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiLandingLanding extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::landing.landing'
    >;
    navigation: Schema.Attribute.Component<'button.button', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.Component<'text-comp.text-comp', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavigationBarNavigationBar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    language: Schema.Attribute.Component<'button.button', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    navigation: Schema.Attribute.Component<'text-comp.text-comp', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiPortfolioSectionPortfolioSection
  extends Struct.SingleTypeSchema {
  collectionName: 'portfolio_sections';
  info: {
    displayName: 'portfolio-section';
    pluralName: 'portfolio-sections';
    singularName: 'portfolio-section';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSkillSectionSkillSection extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'skill-section';
    pluralName: 'skill-sections';
    singularName: 'skill-section';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::skill-section.skill-section'
    >;
    publishedAt: Schema.Attribute.DateTime;
